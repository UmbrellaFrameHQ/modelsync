...
```bash
dotnet add package UmbrellaFrame.ModelSync.Core --version 1.4.0
...
| Current release | [1.4.0 notes](docs/releases/1.4.0.md) · [Migration guide](docs/migrations/1.3.0-to-1.4.0.md) |

### Versioning, Release Notes and Migration Guides

Start with the [release notes](docs/releases/1.4.0.md) before upgrading. Behavior-sensitive changes are paired with a focused [migration guide](docs/migrations/1.3.0-to-1.4.0.md), while the complete history remains in [CHANGELOG.md](CHANGELOG.md).
